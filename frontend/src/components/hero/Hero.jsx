...
const Hero = () => {
  return (
    <section 
      className="bg-white p-6 md:p-12 lg:p-16 flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-12 lg:space-x-24 container mx-auto"
      aria-labelledby="hero-title"
    >
      <div className="flex-1 text-center md:text-left">
        <h1 
          id="hero-title" 
          className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-[var(--navy-blue)]"
        >
          O'zbekneftgaz <span className='text-orange-500' >yoshlar platformasida</span>
        </h1>
        
        <p className="text-gray-700 text-base md:text-lg lg:text-xl leading-relaxed mb-8">
          kelajagingiz poydevorini yarating, tadbirlarimizga ishtirok etib oʻz qobiliyatingizni namoyon eting.
        </p>
