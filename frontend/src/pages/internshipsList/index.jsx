...
export default function InternshipsList() {
	...
	const getShortDescription = internship => {
		return (
			internship[`short_description_${currentLang}`] ||
			internship.short_description_ru ||
			internship.short_description_uz ||
			internship.short_description_en ||
			''
		)
	}
	...
	return (
		<div className='w-full overflow-hidden relative z-0'>
			<motion.section
				...
				className='relative bg-gradient-to-br from-orange-900 via-amber-700 to-yellow-900 text-white py-12 md:py-20 px-4 md:px-12'
			>
				...
				<div className='container mx-auto relative'>
					...
					>
						...
						<p className='text-base sm:text-lg md:text-xl text-orange-100 px-2'>
					...
					<div className='grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8'>
						...
						>
							<div className='text-3xl sm:text-4xl font-bold text-green-600 mb-2'>
								{internships.reduce((sum, i) => sum + i.positions, 0)}
							</div>
							<div className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
								{t('internships.totalPositions')}
							</div>
						</motion.div>
						<motion.div
							initial={{ opacity: 0, y: 20 }}
						...
						>
							...
							<div className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
								{t('internships.totalInternships')}
							</div>
						</motion.div>
					</div>
				</div>
							...
							>
								<div className='md:flex'>
									<div className='md:w-2/5 relative h-48 md:h-auto overflow-hidden'>
										<motion.img
											src={internship.image || '/images/placeholder.jpg'}
											alt={getTitle(internship)}
									...
									<div className='md:w-3/5 p-5 md:p-8 flex flex-col justify-between'>
										<div>
											<h2 className='text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-200 mb-3 md:mb-4 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors'>
												{getTitle(internship)}
											</h2>
											...
											<div className='grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 mb-4 md:mb-6'>
												...
												<div className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
													...
													<div>
														<span className='font-semibold block text-gray-800 dark:text-gray-200'>
															{t('internships.positions')}
														</span>
														{internship.positions}{' '}
														{t('internships.positionsAvailable')}
													</div>
												</div>
											</div>
										</div>
										<div className='flex flex-col sm:flex-row gap-3'>
											<Link
												...
												className='flex-1 text-center px-5 py-2.5 md:py-3 bg-gradient-to-r from-orange-600 to-amber-600 text-white font-semibold rounded-lg hover:from-orange-700 hover:to-amber-700 transition-all duration-300 transform hover:scale-105 shadow-md text-sm sm:text-base'
											>
			...
			<motion.section
				...
				whileInView={{ opacity: 1, y: 0 }}
				viewport={{ once: true }}
				className='py-12 md:py-16 px-4 md:px-12 bg-gradient-to-br from-orange-900 via-amber-700 to-yellow-900 text-white'
			>
				<div className='container mx-auto max-w-4xl text-center'>
					<h2 className='text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6'>
						{t('internships.cta.title')}
					</h2>
					<p className='text-base sm:text-lg md:text-xl text-orange-100 mb-6 md:mb-8 px-4'>
						{t('internships.cta.description')}
					</p>
					<Link
						to='/about'
						className='inline-block px-6 md:px-8 py-3 md:py-4 bg-white text-orange-600 font-semibold rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg text-sm sm:text-base'
					>
